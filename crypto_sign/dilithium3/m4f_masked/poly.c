 ...
 **************************************************/
void poly_reduce(poly *a) { asm_reduce32(a->coeffs); }
 ...
 * Arguments:   - poly *a: pointer to input/output polynomial
 **************************************************/
void poly_caddq(poly *a) { asm_caddq(a->coeffs); }
 ...
 * Arguments:   - poly *a: pointer to input/output polynomial
 **************************************************/
void poly_freeze(poly *a) { // modified, couldn't get asm_freeze to work
...
void polyz_unpack_positive(poly *r, const uint8_t *a) {
  unsigned int i;
#if GAMMA1 == (1 << 17)
  for (i = 0; i < N / 4; ++i) {
    r->coeffs[4 * i + 0] = a[9 * i + 0];
