...
#define TAU 49
#define BETA 196
#define LOG_GAMMA1 19
#define GAMMA1 (1 << 19)
#define GAMMA2 ((Q - 1) / 32)
#define OMEGA 55
#define CRYPTO_ALGNAME "Dilithium3"
#define ALPHA 2 * GAMMA2
#define INV_ALPHA 8380401
...
#endif
#define MSK_POLYZ_PACKEDBYTES (NSHARES * POLYZ_PACKEDBYTES)
#define BS_POLYZ_PACKEDBYTES                                                   \
  4 * NSHARES *(LOG_GAMMA1 +                                                   \
                1) // amount of random uint32 required for bs_polyz_unpack
#define POLY_UNIFORM_GAMMA1_NBLOCKS                                            \
  ((POLYZ_PACKEDBYTES + STREAM256_BLOCKBYTES - 1) / STREAM256_BLOCKBYTES)
#define MSK_POLY_UNIFORM_GAMMA1_NBLOCKS                                        \
  ((MSK_POLYZ_PACKEDBYTES + STREAM256_BLOCKBYTES - 1) / STREAM256_BLOCKBYTES)
